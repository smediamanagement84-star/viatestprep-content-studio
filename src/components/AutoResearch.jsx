...
// ─── Main Component ──────────────────────────────────────────────────────────
export default function AutoResearch({ weeklyPlan, setWeeklyPlan, weeklyResearch, setWeeklyResearch, setPrefilledAsset, setActiveTab: setParentTab }) {
  ...
  return (
    <div style={{ padding: '28px 32px', minHeight: '100vh' }}>
      ...
      {research && !loading && (activeTab === 'trends' || activeTab === 'plan') && (
